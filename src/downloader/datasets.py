...
Usage:
    python -m src.downloader.datasets --all
    python -m src.downloader.datasets --paper warwel_2025_copiapo_refraction
    python -m src.downloader.datasets --classification RAW
    python -m src.downloader.datasets --access open
    python -m src.downloader.datasets --region "North Chile"
    python -m src.downloader.datasets --all --output ./data/ --dry-run
"""
